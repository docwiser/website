            ...
            <div class="mt-1">
              <input
                ...
                :class="{ 
                  ...
                  authStore.error || (form.confirmPassword && form.password !== form.confirmPassword) 
                }"
                placeholder="Confirm your password"
              />
            </div>
            <p v-if="form.confirmPassword && form.password !== form.confirmPassword" class="mt-2 text-sm text-error-600 dark:text-error-400">
...
const handleGoogleLogin = async () => {
  ...
  if (success) {
    uiStore.addNotification({
      type: 'success',
      title: 'Welcome!',
      message: 'You have been successfully signed up with Google.'
    })
  }
}
